...
const tierContent = {
  IGNITE: {
    ...
    journey: "Self-led courses, assessments, and frameworks you can apply immediately, at your own pace, on your own terms.",
    features: [
  ...
  EMBODY: {
    ...
    journey: "Embedded strategic partnership (6+ months) to co-architect permanent organizational capacity, capability, and adaptability.",
    features: [
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col pb-8">
                  ...
                  <p className="text-body text-foreground -sm leading-relaxed mt-6">
                    {content.journey}
                  </p>
                </div>
