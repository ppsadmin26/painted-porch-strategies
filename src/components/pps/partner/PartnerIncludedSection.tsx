        ...
        <div className="bg-white p-8 rounded-xl shadow-sm">
          ...
          <div className="mt-8 p-6 bg-lime/10 border border-lime/30 rounded-lg">
            ...
            <p className="text-body -sm text-foreground">
              We only enter partnerships where we believe meaningful progress is possible - together. If we're not the right fit, we'll tell you and point you in the right direction.
            </p>
          </div>
        </div>
      </div>
