    ...
    <div className="mt-12 scroll-mt-24" id="all-workshop-topics">
      <div className="text-center mb-6">
        ...
        <p className="text-foreground/80 max-w-2xl mx-auto">
          The topics here cover our full workshop catalog, including speaking topics that can be delivered as a <strong>60-minute keynote</strong> or expanded into a <strong>2+ hour interactive session</strong> tailored to your team.
        </p>
      </div>
