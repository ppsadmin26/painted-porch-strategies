    ...
    <section className="py-12 md:py-20 bg-gradient-to-br from-strategic/5 via-white to-bluedoor/5">
      <div className="container max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8">
          <p className="text-body text-bluedoor mb-6 font-bold">What's possible for your organization <span className="underline">right now</span>?</p>
        ...
        <p className="text-body text-foreground mb-12 font-bold">
