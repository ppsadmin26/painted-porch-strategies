  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div ref={contentRef} className="container max-w-5xl mx-auto px-6 text-center relative z-10">
        ...
        >
          The future sh<span className="text-raspberry font-bold">IF</span>t you're considering might be exactly right. Now find out if your organization is positioned to make it happen.
        </h2>
