  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div ref={contentRef} className="container max-w-5xl mx-auto px-6 text-center relative z-10">
        ...
        <h2 
          className={`text-2xl md:text-4xl font-bold text-white mb-8 max-w-[700px] mx-auto transition-all duration-700 ease-out delay-150 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
          }`}
        >
          The sh<span className="text-raspberry">IF</span>t you're considering might be exactly right. Now find out if your organization is built to make it stick.
        </h2>
