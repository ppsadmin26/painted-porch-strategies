...
const faqs = [
  ...
  {
    question: "How is this different from traditional consulting assessments, strategic planning, or a readiness score?",
    answer: "Traditional consulting assessments often take weeks of stakeholder interviews and leave you with a dense report and a proposal for ongoing services. Strategic planning usually assumes the direction is already set and focuses on mapping execution. Readiness scores measure how much communication and management effort it will take to push a change forward, how hard you'll have to push to get it across the finish line. They focus on completion, not necessarily coherence.\n\nThe Blue Door works upstream of all of that. It surfaces what's actually viable now, based on what your organization is built to carry, before you commit to any one direction. In less than 30 minutes, you get a clear architectural read, not a scorecard or a binder. The question isn't how hard you'll have to push to finish, but whether the change will stand up once you do. That's the difference between change management and change origination.\n\nAnd every Blue Door Compass result is built from your specific responses. AI-powered pattern recognition combined with strategic review from the Painted Porch team."
  },
  {
