      ...
      <div className="container max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-body text-muted-foreground max-w-4xl mx-auto">
            nd What's genuinely available for your organization <em>right now</em>? Not in theory, not at full potential, but given how your leadership, systems, and people are structured today.
          </p>
