      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          <div className="bg-navy/30 backdrop-blur-sm p-8 md:p-10 rounded-lg">
            ...
            <p className={`font-poppins font-normal text-lead md:text-lead text-white mb-6 transition-all duration-700 ease-out delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            ...
            <p className={`font-poppins font-bold text-lead md:text-lead text-white mb-8 whitespace-pre-line transition-all duration-700 ease-out delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
