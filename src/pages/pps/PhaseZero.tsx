...
const wherePhaseZeroLeads = [
  ...
  },
  {
    ...
    body: "Ongoing partnership across all three Pillars to build organizational capability and capacity that remain useful long after a single initiative ends",
    to: "/partner",
        ...
        <FadeIn className="container max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-5 text-lg md:text-xl text-charcoal/85 leading-relaxed">
            ...
            <p>
              ...
              the next big <ShIFt lowercase /> hardens into execution, to examine what deserves pursuit, what requires reinforcement, and what may be pulling attention in the wrong direction.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <FadeIn className="container max-w-3xl mx-auto px-6">
          ...
          <p className="text-lg md:text-xl text-charcoal/85 leading-relaxed mb-5">
            It's the phase where you determine what deserves your attention,
            energy, and commitment. Not what to copy or catch up to, but what to{" "}
