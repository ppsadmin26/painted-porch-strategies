        ...
        <FadeIn className="container max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-5 text-lg md:text-xl text-charcoal/85 leading-relaxed">
            ...
            <p>
              ...
              the next big <ShIFt lowercase /> hardens into execution, to examine what deserves pursuit, where strain already exists, and what direction makes the most sense from here.
            </p>
          </div>
