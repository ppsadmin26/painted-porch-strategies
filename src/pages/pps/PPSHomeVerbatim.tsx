...
/* -------------------------------------------------------------------------- */
/*  2. There's A Lot of ShIFt Happening Right Now (verbatim copy)             */
/*     + numbered 3AM strip (kept from current home design)                   */
/* -------------------------------------------------------------------------- */
...
function ShiftSection() {
  return (
    <section className="relative py-24 md:py-36 bg-muted overflow-hidden">
      ...
      {/* Numbered 3AM strip — kept from current home design */}
      <FadeIn className="relative container max-w-6xl mx-auto px-6 mt-14">
        <div className="bg-white rounded-2xl shadow-sm p-10 md:p-14">
          <p className="text-center text-sm font-poppins font-semibold uppercase tracking-[0.2em] text-primary mb-10">
      ...
      <FadeIn className="relative container max-w-3xl mx-auto px-6">
        <div className="mt-14 space-y-6 text-lg md:text-xl text-charcoal/85 leading-relaxed">
    ...
    <section className="relative py-24 md:py-36 bg-navy text-white overflow-hidden">
      ...
      <FadeIn className="relative container max-w-4xl mx-auto px-6">
        ...
        <h2 className="font-poppins font-bold text-4xl md:text-6xl leading-tight mb-12 text-center">
          The Blue Door
          <span className="block text-2xl md:text-3xl text-white/70 font-normal mt-3 italic">
    ...
    <section className="relative py-24 md:py-36 bg-muted/60 overflow-hidden">
      <FadeIn className="relative container max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-5 text-lg md:text-xl text-charcoal/85 leading-relaxed mb-12">
          ...
          <p>Most organizations already know how to launch initiatives.</p>
          <p>
...
export default function PPSHomeVerbatim() {
  useDocumentSeo({
    title: "Home (Verbatim) | Painted Porch Strategies",
    description:
      "Alternate home page using the verbatim copy with the numbered 3AM questions strip.",
  });
