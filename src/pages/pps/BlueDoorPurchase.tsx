        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="mt-8 p-6 bg-raspberry/10 border-l-4 border-raspberry rounded-r-lg">
              <p className="text-body font-bold text-raspberry -sm">
                100% Clarity Guarantee
              </p>
              <p className="text-body text-foreground -sm mt-2">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form onSubmit={handleCheckout} className="space-y-6">
                <div>
                  ...
                  />
                  {errors.name && (
                    <p className="text-body text-raspberry -sm mt-1">{errors.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.email && (
                    <p className="text-body text-raspberry -sm mt-1">{errors.email}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.company && (
                    <p className="text-body text-raspberry -sm mt-1">{errors.company}</p>
                  )}
                </div>
                ...
                <p className="text-body text-center text-muted-foreground -sm">
                  You'll be redirected to Stripe for secure payment
                </p>
              </form>
            </div>

            <p className="text-body text-center text-muted-foreground -sm mt-6">
              Questions?{" "}
              <Link
