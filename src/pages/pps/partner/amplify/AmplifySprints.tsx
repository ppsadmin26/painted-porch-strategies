    ...
    faqs: [
      {
        ...
        answer:
          "Yes. The Blue Door Organizational Appraisal is required for Strategic Sprints. It gives us (and you) the strategic clarity needed to focus your sprint investment.",
      },
      {
