  ...
  return (
    <div>
      ...
      <TierHeroSection
        ...
        description="Three voices. One mission: to partner with leaders and teams who are ready to architect change, communicate with clarity, and build the capability and mindset to carry what comes next."
        ctas={[
