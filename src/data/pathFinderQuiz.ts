...
export const OFFERINGS = {
  ...
  stracticalLeader: { key: "stracticalLeader", name: "The Stractical Leader (Workshop)", facilitator: "Amy", tier: "Workshop", url: "/partner/amplify/workshops", blurb: "Front-line managers learn to lead in the integration zone between strategy and tactics — asking sharper questions and shaping decisions, not just executing them." },
